...
def parallel_fetch(symbol, interval, start_date, end_date, num_threads=10):
    ...
    with ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        for i in range(num_threads):
            ...
            futures.append(executor.submit(fetch_data_for_period, symbol, interval, part_start_date, part_end_date))
...
if __name__ =='__main__':
    ...
    all_data = parallel_fetch('BTCUSDT', '15m', start_date, end_date)
